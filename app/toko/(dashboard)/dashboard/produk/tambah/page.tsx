...
import { createStoreProduct } from "@/lib/actions/product.actions";
import { ImageUpload } from "@/components/admin/ImageUpload";
import { productCategoryService } from "@/lib/services/product-category.service";
import type { ProductCategory } from "@/types";

export default function TokoTambahProdukPage() {
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">Unggah produk jualan Anda ke etalase publik.</p>
        </div>
      </div>
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select name="category" required disabled={isLoadingCategories} className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-slate-800 bg-white">
                    {isLoadingCategories ? (
          ...
          <div>
            ...
            <div className="space-y-6">
              {/* Foto Produk */}
              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-700">Foto Produk Pertama <span className="text-red-500">*</span></label>
                <ImageUpload id="images" name="images" />
              ...
              <div className="flex items-center gap-2 mt-4">
                <input type="checkbox" name="is_featured" id="featured" className="w-4 h-4 text-emerald-600 rounded border-slate-300 focus:ring-emerald-500" />
