...
import { dummyProducts, productCategories } from "@/lib/dummy-data";
...
export default function TokoPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="relative py-20 bg-gradient-to-br from-amber-600 via-amber-500 to-yellow-400 overflow-hidden">
