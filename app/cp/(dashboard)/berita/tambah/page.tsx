    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">Buat artikel, berita, atau pengumuman baru untuk warga.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none text-slate-800 bg-white">
        ...
        <div className="p-6 border-t border-slate-200 bg-slate-50 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <input type="checkbox" id="publish" className="w-4 h-4 text-primary rounded border-slate-300 focus:ring-primary" defaultChecked />
            <label htmlFor="publish" className="text-sm font-medium text-slate-700">Langsung Publikasikan</label>
          </div>
